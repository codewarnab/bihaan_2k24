...
export default function EventLogs() {
    ...
    type ActionFilter = "all" | "food collected" | "merchandise collected" | "Food  collected for Volunteer" | "Food  collected for faculty" | "Added new student" | "Added new volunteer" ;
